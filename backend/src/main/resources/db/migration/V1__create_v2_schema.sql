...
CREATE TABLE IF NOT EXISTS login_record (
    ...
    create_time DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    KEY idx_login_account_time (login_account, create_time),
    KEY idx_login_user_time (account_id, create_time),
...
CREATE TABLE IF NOT EXISTS point_flow (
    ...
    deleted_at DATETIME(3) NULL,
    PRIMARY KEY (id),
    KEY idx_point_member_time (member_id, create_time),
...
CREATE TABLE IF NOT EXISTS resource_status_log (
    ...
    create_time DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    KEY idx_resource_status_log (resource_id, create_time),
...
CREATE TABLE IF NOT EXISTS download_record (
    ...
    deleted_at DATETIME(3) NULL,
    PRIMARY KEY (id),
    KEY idx_download_member_time (member_id, create_time),
...
CREATE TABLE IF NOT EXISTS request_post (
    ...
    deleted_at DATETIME(3) NULL,
    PRIMARY KEY (id),
    KEY idx_request_status_time (status, create_time),
...
CREATE TABLE IF NOT EXISTS request_reply (
    ...
    KEY idx_reply_request (request_id, status, create_time),
...
CREATE TABLE IF NOT EXISTS request_status_log (
    ...
    create_time DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    KEY idx_request_status_log (request_id, create_time),
...
CREATE TABLE IF NOT EXISTS appeal_record (
    ...
    deleted_at DATETIME(3) NULL,
    PRIMARY KEY (id),
    KEY idx_appeal_status_time (status, create_time),
...
CREATE TABLE IF NOT EXISTS notification_event (
    ...
    PRIMARY KEY (id),
    KEY idx_event_status_time (status, create_time),
...
CREATE TABLE IF NOT EXISTS system_notice (
    ...
    deleted_at DATETIME(3) NULL,
    PRIMARY KEY (id),
    KEY idx_notice_receiver_read (receiver_id, is_read, create_time),
...
CREATE TABLE IF NOT EXISTS admin_operation_log (
    ...
    deleted_at DATETIME(3) NULL,
    PRIMARY KEY (id),
    KEY idx_admin_log_admin_time (admin_id, create_time),
...
CREATE TABLE IF NOT EXISTS search_log (
    ...
    create_time DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    KEY idx_search_member_time (member_id, create_time),
